package com.example.gd.Retrofit

import android.util.Log
import android.widget.Toast
import com.example.okhttpex.API
import com.example.okhttpex.Constants.TAG
import com.example.okhttpex.Utils.isJsonArray
import com.example.okhttpex.Utils.isJsonObject
...
//        })
        ...
        val baseParameterInterceptor: Interceptor = (object : Interceptor{
            override fun intercept(chain: Interceptor.Chain): Response {
                ...
                val newRequest = chain.request().newBuilder().addHeader("Authorization", "Bearer ${API.ACCESS_TOKEN}").build()
