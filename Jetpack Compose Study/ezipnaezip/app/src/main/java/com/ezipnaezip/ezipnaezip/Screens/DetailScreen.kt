...
import com.ezipnaezip.ezipnaezip.Button.*
import com.ezipnaezip.ezipnaezip.Effects.*
import com.ezipnaezip.ezipnaezip.Model.Comments
import com.ezipnaezip.ezipnaezip.Model.PostPostnum
import com.ezipnaezip.ezipnaezip.Retrofit.RetrofitManager
import com.ezipnaezip.ezipnaezip.ui.theme.SearchBarBD
                ...
                Column(modifier = Modifier.padding(horizontal = 16.dp)) {
                    ...
                    Row(modifier = Modifier.padding(vertical = 8.dp)) {
                        Column {
                            ...
                            Spacer(modifier = Modifier.padding(vertical = 8.dp))
                            Row {
                                FavoriteButton(postPostnum.like)
                                if (!postPostnum.isMe) BookmarkButton(postPostnum.bookmark)
