...
import com.ezipnaezip.ezipnaezip.Effects.CommunitySearchBar
import com.ezipnaezip.ezipnaezip.Effects.productFrame
...
import com.ezipnaezip.gd.Utils.List.TAGLIST
    ...
    if (postList.size == 0 && loadPost) {
        ...
        Column(
            ...
            LazyVerticalGrid(
                ...
                items(postList) { post ->
                    productFrame(post, navController, "community", post.bookmark, post.me)
                }
