package com.ezipnaezip.ezipnaezipn.navigation
...
import com.ezipnaezip.ezipnaezip.Screens.*
    ...
    Scaffold(
        ...
        Box(Modifier.padding(it)) {
            NavHost(
                ...
                composable(
                    route = "${CommunityNavigationScreens.Detail.route}/{variable}",
                    ...
                    DetailScreen(
                        ...
                        postNum = variable!!.toInt()
                    )
                }
                composable(
                    route = "${CommunityNavigationScreens.User.route}/{variable}",
                    arguments = listOf(navArgument("variable") { type = NavType.StringType })
                ) {entry ->
                    val variable = entry.arguments?.getString("variable")
                    UserScreen(
                ...
                composable(
                    route = "${MyNavigationScreens.Detail.route}/{variable}",
                    arguments = listOf(navArgument("variable") { type = NavType.StringType })
                ) { entry ->
                    val variable = entry.arguments?.getString("variable")
                    DetailScreen(
                ...
                composable(
                    route = "${MyNavigationScreens.User.route}/{variable}",
                    arguments = listOf(navArgument("variable") { type = NavType.StringType })
                ) {entry ->
                    val variable = entry.arguments?.getString("variable")
                    UserScreen(
