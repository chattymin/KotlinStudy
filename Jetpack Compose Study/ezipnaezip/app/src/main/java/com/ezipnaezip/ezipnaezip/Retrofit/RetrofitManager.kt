package com.ezipnaezip.ezipnaezip.Retrofit

import android.content.Context
import android.net.Uri
import android.util.Log
import com.ezipnaezip.ezipnaezip.Model.*
import com.ezipnaezip.ezipnaezip.Screens.OAuthData
import com.ezipnaezip.gd.Utils.API
                ...
                when (response.code()) {
                    200 -> { // 정상 연결
                        response.body()?.let {
                            ...
                            val likesCount = data.get("likesCount")?.asInt ?: 0
